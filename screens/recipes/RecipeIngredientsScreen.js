...
import { View, Text, TextInput, ActionSheetIOS, ScrollView } from 'react-native'; // CheckBox,
...
function RecipeIngredients(props) {
  ...
  const setDeletedIngredient = useStoreActions((actions) => actions.setDeletedIngredient);
